export default {
  ...
  board: {
    ...
    settingsBoardConfiguration: 'Board Configuration',
    settingsBoardTitle: 'Board Title',
    settingsBoardDescription: 'Board Description',
    ...
    settingsMembersCanEditCards: 'Members can edit cards',
    settingsMembersCanDeleteCards: 'Members can delete cards',
    settingsMembersCanAddColumns: 'Members can add columns',
    settingsMembersCanInvite: 'Members can invite others',
    settingsBoardMembers: 'Board Members',
    settingsOwner: 'Owner',
    settingsAdmin: 'Admin',
    ...
    errors:
      {
        ...
        fileSizeExceeded: 'File {fileName} exceeds the maximum size of {maxSize}MB',
        fileTypeNotSupported: 'File type not supported. Allowed types: JPEG, JPG, PNG, WEBP, PDF, DOC, DOCX, XLSX',
        totalSizeExceeded: 'Total upload size exceeds the limit of {maxSize}MB',
        uploadFailed: 'Upload failed',
        errorUploadingFile: 'Error uploading file',
        errorDownloadingAttachment: 'Error downloading attachment',
      },
    confirmations: {
