      ...
      <div class="kanban-column" v-for="column in board.columns">
        ...
        <div class="kanban-card card p-2 mx-2" v-for="card in column.itens">
          <div class="d-flex justify-content-between align-items-center">
            ...
            <div>
              <!--                <button class="btn btn-sm btn btn-light edit-column"><i class="bi bi-pencil-square"></i></button>-->
              <!--              <button class="btn btn-sm tn-sm btn btn-light remove-task"><i class="bi bi-x"></i></button>-->
            </div>
          </div>
